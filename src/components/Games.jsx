  ...
  return (
    <Section id="games" className="border-t border-line">
      ...
      <p className="mt-4 max-w-xl text-base text-muted">
        Two small games, built straight into the site — a minimax-powered Tic-Tac-Toe and a
        memory match. No servers, no scores to chase. Just the DOM and a bit of logic.
      </p>
